...
THIS PROJECT IS EXTRACTED FROM [paulharris/miniball](https://github.com/paulharris/miniball)

# Miniball
A Java library to compute the [miniball](http://en.wikipedia.org/wiki/Bounding_sphere) (a.k.a. _min-circle_, _min-sphere_, _smallest enclosing sphere_, etc.) of a point set.
